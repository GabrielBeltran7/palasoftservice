                        ...
                        <div className="project-items style-2">
                            <div className="project-image">
                                ...
                                <div className="project-content">
                                    <p>Tecnología</p>
                                    <h4>
                                        <Link href="/project-details">Desarrollo de Software</Link>
                                    </h4>
                        ...
                        <div className="project-items style-2">
                            <div className="project-image">
                                ...
                                <div className="project-content">
                                    <p>Tecnología</p>
                                    <h4>
                                        <Link href="/project-details">Soluciones Analíticas</Link>
                                    </h4>
                                    <Link href="/project-details" className="arrow-icon">
                                        <i className="fa-solid fa-arrow-right" />
                                    </Link>
                        ...
                        <div className="project-items style-2">
                            <div className="project-image">
                                ...
                                <div className="project-content">
                                    <p>Soluciones</p>
                                    <h4>
                                        <Link href="/project-details">Soluciones de Diseño</Link>
                                    </h4>
                                    <Link href="/project-details" className="arrow-icon">
                                        <i className="fa-solid fa-arrow-right" />
                                    </Link>
