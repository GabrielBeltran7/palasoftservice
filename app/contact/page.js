...
export default function Contact() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!SERVICE_ID || !TEMPLATE_ID || !PUBLIC_KEY) {
      setFeedback("La configuración de EmailJS es incompleta. Verifica tus variables NEXT_PUBLIC.");
      return;
    }
    ...
    setFeedback("");
        ...
        console.log("EmailJS - parámetros de envío:", {
          service: SERVICE_ID,
    ...
    try {
      ...
      setFeedback("¡Mensaje enviado con éxito! Pronto nos pondremos en contacto.");
      setFormData({ name: "", email: "", phone: "", message: "" });
    } catch (error) {
      console.error("Error enviando el mensaje:", error);
      setFeedback("No fue posible enviar el mensaje. Intenta nuevamente.");
    } finally {
      setSending(false);
    }
  };
                      ...
                      <div className="contact-info-area-2">
                        <div className="contact-info-items mb-4">
                          ...
                          <div className="content">
                            <p className="text-white">Llámanos 24/7</p>
                            <div>
                              <Link
                                href="https://wa.me/573208903406?text=Hola%20Palasoft%20Services%2C%20me%20interesa%20conocer%20más%20sobre%20sus%20servicios."
                                target="_blank"
                        ...
                        <div className="contact-info-items border-none">
                          ...
                          <div className="content">
                            <p>Ubicación</p>
                            <h3>
                              Mosquera, KR 10 # 15 A - 22 AP 200, Cundinamarca,
                              Colombia
                            </h3>
                          </div>
                        </div>
                  ...
                  <div className="col-lg-6">
                    <div className="contact-content">
                      ...
                      <p>
                        ...
                        con soluciones tecnológicas innovadoras. Contáctanos y
                        descubre cómo podemos impulsar tu crecimiento digital.
                      </p>
          ...
          <div className="map-section">
            <div className="map-items">
              <div className="googpemap">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.871998391301!2d-74.229!3d4.7105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f780ff1fcbbfd%3A0xfdeb4c58fea71264!2sKR%2010%20%2315A-22%2C%20Mosquera%2C%20Cundinamarca%2C%20Colombia!5e0!3m2!1ses!2sco!4v1696176000000!5m2!1ses!2sco"
                  width="100%"
                  height="450"
                  style={{ border: 0 }}
                  allowFullScreen=""
