...
export default function About() {
  return (
    <>
      <Layout headerStyle={1} footerStyle={2} breadcrumbTitle="Nosotros">
        <div>
          <section
                    ...
                    <div className="about-content">
                      <div className="section-title">
                        <span className="wow fadeInUp">
                          ACERCA DE PALASOFT SERVICE
                        </span>
                        <h2 className="wow fadeInUp" data-wow-delay=".3s">
                          Estamos Aumentando el Éxito Empresarial con{" "}
                      ...
                      >
                        ...
                        ofreciendo soluciones tecnológicas <br /> innovadoras
                        que impulsan el crecimiento y la competitividad de tu
                        empresa.
                      </p>
                      <div className="about-icon-items">
                        ...
                        >
                          ...
                          <div className="content">
                            ...
                            <p>Solucionamos desafíos tecnológicos complejos</p>
                          </div>
                        </div>
                        <div
                          className="icon-items wow fadeInUp"
                        ...
                        >
                          ...
                          <div className="content">
                            ...
                            <p>Innovación constante para el futuro digital</p>
                          </div>
                        </div>
                      </div>
          ...
          <section className="offer-section fix section-bg-2 section-padding">
            ...
            <div className="container">
              <div className="section-title text-center">
                <span className="wow fadeInUp">Nuestra Oferta</span>
                <h2 className="text-white wow fadeInUp" data-wow-delay=".3s">
                  Mejoramos y Lideramos Usando <br /> Tendencias Tecnológicas
                </h2>
              </div>
              <div className="row">
                <div
          ...
          <section className="project-section-2 section-padding fix">
            ...
            <div className="container">
              <div className="section-title-area">
                <div className="section-title">
                  <span className="wow fadeInUp">PROYECTOS</span>
                  <h2 className="wow fadeInUp" data-wow-delay=".3s">
  Descubre Nuestros Proyectos Más Recientes <br /> que Impulsan el Éxito de Nuestros Clientes
</h2>
              ...
              <div className="project-wrapper">
                <ProjectSlider1 showDots cardStyle="rectangular" />
              </div>
            </div>
          </section>
                  ...
                  <ul className="marqee-list d-flex">
                    <li className="marquee-item style-2">
                      <span className="text-slider">
                        <img src="/assets/img/asterisk.svg" alt="icon" />
                      </span>
            ...
            <div className="container">
              <div className="brand-wrapper">
                <h6 className="text-center wow fadeInUp" data-wow-delay=".3s">
                  Más de 250 Marcas Confían en Nosotros
                </h6>
                {/* <BrandSlider1 /> */}
              </div>
            </div>
